...
router.post('/', auth.authenticateToken, auth.allowRoles(['admin', 'veterinario', 'recepcionista']), ctrl.create); // Crear usuario (solo admin/veterinario)
router.put('/:id', auth.authenticateToken, auth.allowRoles(['admin', 'veterinario']), ctrl.update); // Actualizar usuario
router.delete('/:id', auth.authenticateToken, auth.allowRoles(['admin', 'veterinario']), ctrl.delete); // Eliminar usuario (solo admin)
